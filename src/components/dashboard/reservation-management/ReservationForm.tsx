...
import { Student, Reservation } from "@/types";
...
const ReservationForm = ({
  ...
  const {
    ...
    filteredSheets,
    isSheetDisabled,
    studentData: contextStudentData
  } = useReservationForm({
    mode,
    studentData,
    reservationData,
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle>
            {mode === "add" ? "Reserve Sheet" : "Edit Reservation"}
          </DialogTitle>
          <DialogDescription>
            {mode === "add"
              ? "Fill out the form below to reserve a sheet for the student."
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        {...field}
                        disabled={!!contextStudentData?.name}
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
