export const appwriteConfig = {
  ...
  registrationCollectionId: process.env.NEXT_PUBLIC_APPWRITE_REGISTRATIONS_COLLECTION_ID!,
  reservationCollectionId: process.env.NEXT_PUBLIC_APPWRITE_RESERVATIONS_COLLECTION_ID!,
